...
const AITutor = () => {
  ...
  const generateResponse = async (query: string, chatId: string, history: Message[]) => {
    ...
    try {
      if (!apiKey) {
        const errorMessage = "⚠️ **AI Key Required**\n\nPlease set up your Google Analytics Engine API Key to continue.";
      ...
      // Prepare history for Analytics Engine
      ...
      let errorMsg = `**AI Service Error**\n\n${error.message || "An unexpected error occurred while connecting to Analytics Engine."}`;
        ...
        <div className="flex-1 flex flex-col glass rounded-2xl relative overflow-hidden">
          <div className="p-4 md:p-6 pb-2 md:pb-6 flex items-start justify-between gap-4">
            <PageHeader
              ...
              subtitle="Your 24/7 Advanced study companion"
                ...
                >
                  <div className="flex flex-col items-center text-center">
                    ...
                    <p className="text-muted-foreground mb-8 text-sm">
                      To keep this app free for everyone, please use your own Analytics Engine API key.
                    ...
                    <div className="w-full space-y-4">
                      <div className="space-y-1.5">
                        <label className="text-xs font-medium text-muted-foreground uppercase tracking-wider ml-1">
                          Paste your Analytics Engine API Key
                        </label>
                        <input
                          type="password"
                          value={tempKey}
